        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserDalId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDalUserDal", x => new { x.FriendsId, x.UserDalId });
                    table.ForeignKey(
                        name: "FK_UserDalUserDal_Users_FriendsId",
                        column: x => x.FriendsId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserDalUserDal_Users_UserDalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FriendRequests_Notifications_NotificationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDalUserDal_UserDalId",
